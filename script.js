...
function renderRowBands() {
  ...
  computeRowBands().forEach((r, i) => {
    ...
    div.style.cssText = `left:${minX}px;top:${r.top - pad}px;width:${maxX - minX}px;height:${(r.bottom - r.top) + pad * 2}px;background:${ROW_COLORS[i % ROW_COLORS.length]}`;
    const label = document.createElement("span");
    label.className = "rowBand-label";
